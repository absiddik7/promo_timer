            ...
            Expanded(
              child: PageView(
                ...
                children: [
                  ...
                  OnboardingScreen1(onNext: _goToNextScreen, onBack: _goToPreviousScreen),
                  // Screen 2: What Makes This Different
                  OnboardingScreen2(onNext: _goToNextScreen, onBack: _goToPreviousScreen),
                  // Screen 3: What are you focusing on?
                  OnboardingScreen3(onNext: _goToNextScreen, onBack: _goToPreviousScreen),
                  // Screen 4: What gets in your way?
                  OnboardingScreen4(onNext: _goToNextScreen, onBack: _goToPreviousScreen),
                  // Screen 5: How long can you focus?
                  OnboardingScreen5(onNext: _goToNextScreen, onBack: _goToPreviousScreen),
                  // Screen 6: What helps you focus?
                  OnboardingScreen6(onNext: _goToNextScreen, onBack: _goToPreviousScreen),
                  // Screen 7: The Candle (Live Feature Demo)
                  OnboardingScreen7(onNext: _goToNextScreen, onBack: _goToPreviousScreen),
                  // Screen 8: Personalize: Candle & Background Color
                  OnboardingScreen8(onNext: _goToNextScreen, onBack: _goToPreviousScreen),
                  // Screen 9: Personalize: Background Sound
                  OnboardingScreen9(onNext: _goToNextScreen, onBack: _goToPreviousScreen),
                  // Screen 10: Social Proof
                  OnboardingScreen10(onNext: _goToNextScreen, onBack: _goToPreviousScreen),
                  ...
                  // Screen 12: Light Your First Candle
                  OnboardingScreen12(onComplete: widget.onComplete, onBack: _goToPreviousScreen),
                ],
              ),
            ),
          ],
